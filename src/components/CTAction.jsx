const CTAction = () => {
  return (
    <div className="w-full p-4 mt-8 md:mt-10 lg:mt-12 text-center bg-white border border-gray-200  shadow sm:p-8 ">
      <h5 className="mb-2 text-3xl font-bold text-gray-900 ">
        Work fast from anywhere
      </h5>
      <p className="mb-5 text-base text-gray-500 sm:text-lg ">
        Stay up to date and move work forward on iOS & Android. Download the app
        today.
      </p>
